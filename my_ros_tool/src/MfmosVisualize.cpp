...
void visualizePointCloud(const pcl::PointCloud<pcl::PointXYZ>::Ptr __cloud_static, 
                         const pcl::PointCloud<pcl::PointXYZ>::Ptr __cloud_moving,
                         const pcl::PointCloud<pcl::PointXYZ>::Ptr __cloud_movable){
    ...
    viewer.addPointCloud<pcl::PointXYZ>(__cloud_movable, movable_cloud_color_handler, "movable cloud");
    viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 1, "static cloud");
    viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 1.5, "moving cloud");
    viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 1.5, "movable cloud");
...
int main(int agrc, char** argv) {
    ...
    if (agrc != 3) {
        std::cerr << "Usage: " << argv[0] << " <path> <frame>" << std::endl;
        return 1;
    }
    ...
    visualizePointCloud(data->cloud_static, data->cloud_moving,data->cloud_movable);
    delete data;
